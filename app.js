    ...
    <header class="sticky top-0 z-40 border-b border-line/70 bg-paper/85 backdrop-blur-md">
      <div class="container-wide flex items-center justify-between gap-6 py-5">
        <a href="${BASE_URL}/?lang=${lang}" class="group flex flex-col">
          <span class="site-brand-name font-display text-[1.18rem] font-semibold md:text-[1.24rem]">${siteName}</span>
          <span class="site-brand-role text-[0.88rem] text-ink/55 md:text-[0.92rem]">${siteRoleFor(site, lang)}</span>
        </a>
  ...
  <section class="container-wide section-reveal pt-4 pb-10 md:pt-4 md:pb-14">
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      ${points
        .map(
          (point) => `
            <div class="glass-edge rounded-[1.4rem] border bg-white/65 px-6 py-4 backdrop-blur-sm md:px-10">
              <div class="mb-4 flex text-ink">
